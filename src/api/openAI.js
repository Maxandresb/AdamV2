...
let conversationHistory = [
    {
        ...
        - si te preguntan por el registro de dolencias o agenda de dolencias: indica que se encuentra en el menu con el nombre Agenda de dolencias, en la pantalla de dolencias el usuario puede agregar dolencias o sintomas que vaya experimentando para mantener un registro, el formulario de estas dolencias o sintomas permite agregar descripcion, escala de dolor, tiempo desde aparicion, acciones tomadas para remediarlo o medicamentos ingeridos para contrarestarlo. Tambien en esa misma pantalla puede activar las notificaciones para preguntar diariamente por un estado de los sintomas del usuario
