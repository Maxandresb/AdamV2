...
const SignIn = ({ navigation }) => {
  ...
  const guardarDatosUsuario = (datosUsuario) => {
    db.transaction(tx => {
      console.log('Valores a insertar:', datosUsuario.rut, datosUsuario.pnombre, datosUsuario.snombre, datosUsuario.papellido, datosUsuario.sapellido, datosUsuario.alias, datosUsuario.genero, datosUsuario.tipo_sangre, datosUsuario.fecha_nacimiento, datosUsuario.tieneAlergias, datosUsuario.cronico, datosUsuario.donante, datosUsuario.limitacion_fisica, datosUsuario.toma_medicamentos);
      tx.executeSql(
        ...
        [datosUsuario.rut, datosUsuario.pnombre, datosUsuario.snombre, datosUsuario.papellido, datosUsuario.sapellido, datosUsuario.alias, datosUsuario.genero, datosUsuario.tipo_sangre, datosUsuario.fecha_nacimiento.toLocaleDateString(), datosUsuario.tieneAlergias, datosUsuario.cronico, datosUsuario.donante, datosUsuario.limitacion_fisica, datosUsuario.toma_medicamentos],
  ...
  useEffect(() => {
    console.log('DATOS A INSERTAR : ', rut, pnombre, snombre, papellido, sapellido, alias, genero, tipo_sangre, fecha_nacimiento, tieneAlergias, cronico, donante, limitacion_fisica, toma_medicamentos);
